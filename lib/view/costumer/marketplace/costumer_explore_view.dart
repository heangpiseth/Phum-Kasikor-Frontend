  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: ListView(
        ...
        children: [
          const Text('Explore Phum Kasikor',
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    child: const Text('SEASONAL PICK',
                        style: TextStyle(
                            fontSize: 10,
                  ...
                  const Text('Keo Romeat Mangoes',
                      style: TextStyle(
                          color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold)),
                  const Text('Harvested fresh today, from Kampong Speu orchards.',
          ...
          Obx(() => GridView.builder(
                ...
                itemBuilder: (_, i) {
                  final p = controller.popularProducts[i];
                  return ProductCard(
