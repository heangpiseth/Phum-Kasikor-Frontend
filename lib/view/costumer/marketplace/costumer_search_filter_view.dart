  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: TextField(
          controller: TextEditingController(text: controller.queryText.value),
          ...
          children: [
                    ...
                    children: [
                      ...
                      if (controller.isVegetablesOnly.value)
                        _filterTag('Vegetables', () {
                          controller.isVegetablesOnly.value = false;
                          controller.runSearch();
                        }),
                      _filterTag('Under \$${controller.priceMax.value.toInt()}', () {
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Obx(() => Text('${controller.results.length} products found',
                      ...
                      return Card(
                        ...
                        child: ListTile(
                          ...
                          trailing: IconButton(
                            ...
                            onPressed: () => cart.addProduct(p as ProductModel),
                          ),
                        ),
                      );
                    },
      ...
      Container(
        ...
        child: Obx(() => Column(
              ...
              children: [
                ...
                Text('Price Range: \$${controller.priceMin.value.toInt()} - '
                ...
                SwitchListTile(
                  ...
                  activeColor: AppColors.primary,
                  onChanged: (v) {
                    controller.isVegetablesOnly.value = v;
                    controller.runSearch();
                  },
                ),
                const SizedBox(height: 8),
